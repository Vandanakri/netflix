...
class Latest extends React.Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://www.googleapis.com/youtube/v3/search?part=snippet&key=${key}&q=latestseries2021&maxResults=50`
    )
      .then((res) => res.json())
      .then((data) =>
        this.setState({
          ...
          <div className="main_container">
            <div className="main_header flex between .align_center">
              ...
              <section>
                <ul className="flex ">
                  <li>
                    <Link to="/main" className="main_nav_a" href="#">
                      All
                    </Link>
                  </li>
                  <li>
                    <Link to="/music" className="main_nav_a" href="#">
                      Music
                    </Link>
                  </li>
                  <li>
                    <Link to="/hollywood" className="main_nav_a" href="#">
                      Hollywood
                    </Link>
                  </li>
                  <li>
                    <Link to="/trending" className="main_nav_a" href="#">
                      Trending
                    </Link>
                  </li>
                  <li>
                    <Link to="/latest" className="main_nav_a" href="#">
                      Latest
                    </Link>
                  </li>
                </ul>
              ...
              <section className="header_right_main">
                <Link to="/" className="btn btn-rounded main_btn_signout">
                  Sign Out
                </Link>
              </section>
            </div>
